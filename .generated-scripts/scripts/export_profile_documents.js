...
import { buildTeamProfileText, buildUserProfileText, } from '../src/utils/profileText.js';
...
const buildHackathons = (rawHackathons) => {
    const hackathons = [];
...
const buildUserProfile = (user, hackathonMap) => {
...
const buildTeamProfile = (team, hackathonMap) => {
...
async function main() {
    ...
    const rawTeams = JSON.parse(teamsRaw);
    const rawHackathons = JSON.parse(hackathonsRaw);
